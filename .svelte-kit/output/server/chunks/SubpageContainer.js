...
/* empty css                                                */const LangTag_svelte_svelte_type_style_lang = "";
const css$3 = {
...
const Highlight = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  ${validate_component(LangTag$1, "LangTag").$$render($$result, Object.assign({}, $$restProps, { languageName: language.name }, { langtag }, { highlighted }, { code }), {}, {})}
`}`;
});
...
const codeIcon = "/foliole/_app/immutable/assets/code.f9cafe02.svg";
const css$1 = {
...
<div class="${"fo-card fo-card-outlined fo-p-0 fo-m-block-start-1 svelte-yvmrw9"}"><img${add_attribute("src", codeIcon, 0)} alt="${"Code icon"}" class="${"svelte-yvmrw9"}">
  ${validate_component(Highlight$1, "Highlight").$$render(
    $$result,
    {
